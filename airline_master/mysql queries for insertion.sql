...
-- insert into city values(2,'NYC','New york');
-- insert into city values(3,'Dallas','Texas');
-- insert into city values(4,'LA','California');
-- insert into city values(5,'Tempe','Florida');
-- insert into city values(6,'Seattle','Washington');
